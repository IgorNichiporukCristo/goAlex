...
var _excluded = ["id", "size", "value", "items", "controls", "autofocus", "disabled", "visibleItems", "scrollSnapType", "onChange", "aria-label"];
...
var StyledArrow = /*#__PURE__*/(0, _styledComponents["default"])(_Button.Button).withConfig({
  componentId: "plasma-ui__sc-1arqf5u-0"
...
var StyledCarousel = /*#__PURE__*/(0, _styledComponents["default"])(_Carousel.Carousel).withConfig({
  componentId: "plasma-ui__sc-1arqf5u-1"
...
var StyledWrapper = /*#__PURE__*/_styledComponents["default"].div.withConfig({
  componentId: "plasma-ui__sc-1arqf5u-2"
...
var getItems = function getItems(items, infiniteScroll) {
  if (infiniteScroll) {
...
var Picker = function Picker(_ref5) {
  ...
  var theme = (0, _react.useContext)(_styledComponents.ThemeContext); // by default 'true' on high perfomance devices

  var infiniteScroll = (_rest$infiniteScroll = rest.infiniteScroll) !== null && _rest$infiniteScroll !== void 0 ? _rest$infiniteScroll : !theme.lowPerformance;
  var virtualItems = (0, _react.useMemo)(function () {
    return getItems(items, infiniteScroll);
  ...
  var prevValue = (0, _utils.usePreviousValue)((_virtualItems$index = virtualItems[index]) === null || _virtualItems$index === void 0 ? void 0 : _virtualItems$index.value);
  ...
  return /*#__PURE__*/_react["default"].createElement(StyledWrapper, _extends({
    ...
    axis: "y",
    index: index,
    scaleCallback: _utils.scaleCallbacks[size],
    scaleResetCallback: _utils.scaleResetCallback,
  ...
  })), controls && /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(StyledArrow, {
    "data-placement": "top",
    tabIndex: -1,
    view: "clear",
    disabled: disabled,
    outlined: false,
    contentLeft: /*#__PURE__*/_react["default"].createElement(_plasmaIcons.IconChevronUp, {
      size: "s"
    }),
    "aria-hidden": "true",
    onClick: toPrev
    ...
    disabled: disabled,
    outlined: false,
    contentLeft: /*#__PURE__*/_react["default"].createElement(_plasmaIcons.IconChevronDown, {
      size: "s"
    }),
    "aria-hidden": "true",
    onClick: toNext
