...
var StyledButton = /*#__PURE__*/(0, _styledComponents["default"])(_Button.Button).withConfig({
  componentId: "plasma-ui__sc-2vburw-0"
})(["position:absolute;top:0;bottom:0;margin-top:auto;margin-bottom:auto;right:100%;margin-right:0.5rem;", ""], function (_ref) {
  var theme = _ref.theme;
  return (0, _plasmaCore.mediaQuery)('S', theme.deviceScale)((0, _styledComponents.css)(["position:static;width:auto;height:calc(var(--plasma-header-pt) + var(--plasma-header-height) + var(--plasma-header-pb));padding:0;margin-right:1rem;margin-top:calc(var(--plasma-header-pt) * -1);"]));
});
var StyledIcon = /*#__PURE__*/(0, _styledComponents["default"])(_plasmaIcons.IconChevronLeft).withConfig({
  componentId: "plasma-ui__sc-2vburw-1"
