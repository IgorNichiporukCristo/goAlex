...
})(["", " position:absolute;z-index:9200;padding:0.375rem 0.5rem;background-color:", ";border-radius:0.25rem;box-shadow:", ";color:", ";white-space:pre;pointer-events:none;transition:opacity 200ms ease-in-out;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;&[data-popper-placement^='top'] > ", "{bottom:-0.25rem;}&[data-popper-placement^='bottom'] > ", "{top:-0.25rem;}&[data-popper-placement^='left'] > ", "{right:-0.25rem;}&[data-popper-placement^='right'] > ", "{left:-0.25rem;}", ""], caption, dark02, shadows.small, white, StyledArrow, StyledArrow, StyledArrow, StyledArrow, function (_ref) {
  var isVisible = _ref.isVisible,
      animated = _ref.animated;
  return animated && css(["opacity:", ";"], Number(isVisible));
});
/**
...
export var Tooltip = function Tooltip(_ref2) {
  ...
  var _usePopper = usePopper(wrapperElement, tooltipElement, {
    placement: placement,
    modifiers: [{
      name: 'offset',
      options: {
  ...
  return /*#__PURE__*/React.createElement(StyledRoot, rest, children && /*#__PURE__*/React.createElement(StyledWrapper, {
    ref: setWrapperElement
  }, children), /*#__PURE__*/React.createElement(StyledTooltip, _extends({}, attributes.popper, {
