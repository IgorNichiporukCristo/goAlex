var _excluded = ["size", "disabled", "status", "placeholder", "label", "animatedHint", "hasContentLeft", "hasContentRight"];
...
var StyledHint = /*#__PURE__*/styled.span.withConfig({
  componentId: "plasma-web__sc-jlqlq3-0"
...
var StyledLabel = /*#__PURE__*/styled(StyledHint).withConfig({
  componentId: "plasma-web__sc-jlqlq3-1"
...
var StyledPlaceholder = /*#__PURE__*/styled(StyledHint).withConfig({
  componentId: "plasma-web__sc-jlqlq3-2"
...
var StyledInput = /*#__PURE__*/styled.input.withConfig({
  componentId: "plasma-web__sc-jlqlq3-3"
})(["", " ", " box-sizing:border-box;width:100%;background-color:", ";color:", ";caret-color:", ";border:0 none;border-radius:", ";box-shadow:inset 0 0 0 ", " ", ";transition:box-shadow 0.1s ease-in,background-color 0.1s ease-in,color 0.1s ease-in;&:hover{background-color:", ";box-shadow:inset 0 0 0 ", " ", ";}&:disabled{box-shadow:inset 0 0 0 ", " ", ";cursor:inherit;}&::placeholder{color:", ";}", " &:focus,&:hover:focus{background-color:", ";box-shadow:inset 0 0 0 ", " ", ";outline:0 none;}&:focus::placeholder{color:", ";}", " ", ""], applySizes, inputTypo, inputBackground, inputColor, inputCaretColor, inputBorderRadius, inputBorderWidth, inputBorder, inputBackgroundHover, inputBorderWidth, inputBorderHover, inputBorderWidth, inputBorder, inputPlaceholderColor, function (_ref2) {
