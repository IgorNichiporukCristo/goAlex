...
describe('plasma-web: Carousel', function () {
  var Carousel = (0, _plasmaCyUtils.getComponent)('Carousel');
  var CarouselItem = (0, _plasmaCyUtils.getComponent)('CarouselItem');
  it('default', function () {
    var index = 0;
    (0, _plasmaCyUtils.mount)( /*#__PURE__*/_react["default"].createElement(_plasmaCyUtils.CypressTestDecorator, null, /*#__PURE__*/_react["default"].createElement(Carousel, {
      index: index,
      style: {
        margin: '0 -0.5rem'
      },
      ...
      }, /*#__PURE__*/_react["default"].createElement(_Carousel.CarouselCard, item));
    }))));
    cy.wait(100);
