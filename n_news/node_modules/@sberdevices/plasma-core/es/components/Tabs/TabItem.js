...
})(["display:inline;", " ", " ~ &{margin-left:0.375rem;}&:focus,&.focus-visible{outline:0 none;}"], applyEllipsis, StyledTabItemContentLeft);
export var StyledTabItem = /*#__PURE__*/styled.button.withConfig({
