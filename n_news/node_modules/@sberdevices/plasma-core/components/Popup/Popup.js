...
var StyledRoot = /*#__PURE__*/_styledComponents["default"].div.withConfig({
  componentId: "plasma__sc-rpnuzw-0"
...
var StyledPopup = /*#__PURE__*/_styledComponents["default"].div.withConfig({
  componentId: "plasma__sc-rpnuzw-1"
})(["position:absolute;z-index:1;padding:var(--plasma-popup-padding);margin:var(--plasma-popup-margin);width:var(--plasma-popup-width);", ""], function (_ref) {
  var placement = _ref.placement;

  switch (placement) {
    case 'left':
      return (0, _styledComponents.css)(["top:0;right:100%;"]);

    case 'right':
      return (0, _styledComponents.css)(["top:0;left:100%;"]);

    case 'bottom':
    default:
      return (0, _styledComponents.css)(["top:100%;left:0;"]);
  }
});
/**
...
var Popup = /*#__PURE__*/(0, _react.memo)( /*#__PURE__*/_react["default"].forwardRef(function (_ref2, outerRootRef) {
  var disclosure = _ref2.disclosure,
  ...
  var onClick = (0, _react.useCallback)(function (event) {
    if (trigger === 'click') {
      ...
      var targetIsPopup = event.target === popupRef;
  ...
  return /*#__PURE__*/_react["default"].createElement(StyledRoot, _extends({
    ...
    onFocus: onFocus,
    onBlur: onBlur
  }, rest), disclosure, children && /*#__PURE__*/_react["default"].createElement(StyledPopup, {
    ref: popupRef,
    placement: placement,
    style: {
