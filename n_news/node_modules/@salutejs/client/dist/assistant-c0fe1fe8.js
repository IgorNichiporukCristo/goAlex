...
if (/[a-zA-Z]/.test('1.24.2')) {
    console.info('%cPlease use the latest version of SaluteJS Client. Your version is 1.24.2', 'color: yellow; font-size: 14px');
}
...
var createAssistant$1 = function (_a) {
    ...
    return {
        ...
        sendAction: function (action, onData, onError, _a) {
            var _b = _a === void 0 ? {} : _a, name = _b.name, requestId = _b.requestId, mode = _b.mode;
            return sendData({ action: action, name: name, requestId: requestId, mode: mode }, function (data) {
...
if (typeof window !== 'undefined') {
    // eslint-disable-next-line no-underscore-dangle
    window.__ASSISTANT_CLIENT__ = { version: '1.24.2' };
}
...
var createAssistant = function (_a) {
    ...
    var protocol = createProtocol(transport, exports.__assign(exports.__assign({}, configuration), { getInitialMeta: typeof getInitialMeta !== 'undefined' ? function () { return getInitialMeta().then(convertFieldValuesToString); } : undefined, 
