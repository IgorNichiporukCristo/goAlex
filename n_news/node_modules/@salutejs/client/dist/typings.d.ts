...
export interface Assistant<A extends AssistantSmartAppData = AssistantSmartAppData> {
    ...
    sendAction: <D extends AssistantSmartAppCommand['smart_app_data'], E extends AssistantSmartAppError['smart_app_error']>(action: AssistantServerAction, onData?: (data: D) => void, onError?: (error: E) => void, params?: Pick<SendDataParams, 'name' | 'requestId'>) => () => void;
