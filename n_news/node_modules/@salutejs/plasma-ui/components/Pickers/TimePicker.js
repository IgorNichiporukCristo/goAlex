...
var StyledSimpleTimePicker = /*#__PURE__*/(0, _styledComponents["default"])(_SimpleTimePicker.SimpleTimePicker).withConfig({
...
}, _plasmaTokens.whiteTertiary, _plasmaTokens.footnote1, function (_ref2) {
  var _ref2$size = _ref2.size,
      size = _ref2$size === void 0 ? _types.DEFAULT_PICKER_SIZE : _ref2$size;
  return labelFontSize[size];
}, _PickerDots.PickerDots);
var defaultOptions = {
  hours: true,
  minutes: true,
  seconds: true
...
var TimePicker = function TimePicker(_ref5) {
  ...
  var onHoursChange = _react["default"].useCallback(function (_ref6) {
    var h = _ref6.value;
  ...
  var onMinutesChange = _react["default"].useCallback(function (_ref9) {
    var m = _ref9.value;
  ...
  var onSecondsChange = _react["default"].useCallback(function (_ref12) {
    var s = _ref12.value;
  ...
  return /*#__PURE__*/_react["default"].createElement(StyledWrapper, _extends({
    id: id
  }, rest), options.hours && /*#__PURE__*/_react["default"].createElement(StyledSimpleTimePicker, {
    id: id,
    type: "hours",
    autofocus: autofocus,
    disabled: disabled,
    ...
    $size: size
  }), options.minutes && /*#__PURE__*/_react["default"].createElement(StyledSimpleTimePicker, {
    id: id,
    type: "minutes",
    ...
    $size: size
  }), options.seconds && /*#__PURE__*/_react["default"].createElement(StyledSimpleTimePicker, {
    id: id,
    type: "seconds",
